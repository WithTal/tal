...
const DynamicGraphicCopy: React.FC<DynamicGraphicProps> = ({ text, text2, imageUrl, imageHeight, imageWidth }) => {
        ...
        if (node !== null) {
            node.addEventListener('load', () => {
                ...
                if (svgDoc) {
                    ...
                    image.setAttribute('href', "http://localhost:3000/sample.png");
...
export default DynamicGraphicCopy;
