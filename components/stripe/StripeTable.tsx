...
const StripePricingTable = ({ user }: Props) => {
  ...
  return (
    <div className='flex flex-1 flex-col w-full'>
      ...
      <stripe-pricing-table pricing-table-id="prctbl_1O2zfbDPFtnmiAnDx2rOA8Ka"
        publishable-key="pk_test_51O2zVZDPFtnmiAnDYMlY9NS65tXgtJi1bmi2EQtvZeHKvsUvHQPzMOK6DPWqL2ywylKzHhHs6JDeIGrNDGBjTou500nkHAKZ9v"
        client-reference-id={user.id}
        customer-email={user.email}
      >
      </stripe-pricing-table>
