...
export default function SectionPage({ video, chartdata }: {
    video: string, chartdata: {
        sentiment: string;
        'Average Video': number;
        'The Pragmatic Engineer': number;
    }[]
}) {
        ...
        <div className="w-[95%] max-w-6xl mx-auto">
            <header className="relative overflow-hidden  ">
                ...
                <div className="container mt-20  pb-12 lg:pb-36">
                    ...
                    <Card className="mt-4 border-neutral-900 ring-neutral-700 bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950  rounded-xl">
                    ...
                    <div className="container mt-20  pb-12 ">
                        <p className="text-5xl  text-neutral-200 font-semibold  text-center w-full">
                            Specific audience sentiment
                        </p>
                        <Card className="relative mx-auto mt-16 max-w-lg border-neutral-900 ring-neutral-700 bg-gradient-to-r from-neutral-950 via-neutral-900 to-neutral-950  rounded-xl">
                            <div className="absolute top-2 right-4 ">
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <LockClosedIcon className="cursor-pointer h-4 w-4 text-neutral-200" />
                            ...
                            <p className="pt-2 w-full text-neutral-200 text-center text-4xl font-PoppinsBold">
